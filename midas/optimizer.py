...
## Iterate Over Generations  ##
    ...
    def main_PSA(self, restart=False):
        """
        This functions as the main execution logic for PSA. PSA requires a unique fucntion because the algorithm structure
        ...
        Future developers should do everything they can to integrate their algorithms into main. 
