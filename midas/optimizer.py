...
from midas.codes import serpent2
import midas_data
...
class Optimizer():
    ...
    def build_optimizer(self):
        ...
        elif self.input.code_interface == "serpent2":
            self.eval_func = serpent2.evaluate
    ...
    ## Evaluate fitness
            ...
            if 'cost_fuelcycle' in self.input.objectives.keys() and self.input.code_interface not in ['nuscale_database', 'serpent2']:
